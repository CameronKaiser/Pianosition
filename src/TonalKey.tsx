...
export interface TonalKey  { index : number; tonic: string, mode: string; parallelMode: string; chromaticAlterations: ChromaticAlterations, keySignatureOffset: number, sharps: boolean}
