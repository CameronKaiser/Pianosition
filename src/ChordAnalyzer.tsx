...
export function analyzeChord(notes: Note[], tonalKey: TonalKey) {
...
//  Determine the inversion of the chord by comparing the bass to the fundamental
    function determineInversion(root: Note, notes: Note[]){
        ...
        return {    "upper": inversions[inversion][structure].upper, 
...
export var numerals: Numerals = {"major": ["I", "ii", "iii", "IV", "V", "vi", "vii"],
                                 "minor": ["i", "ii", "III", "iv", "v", "VI", "VII"]};

interface Inversions { [key: string]: {[key: string]: {[key: string]: string}}};
export var inversions: Inversions = {
    "root": {
        "triad":  {
            "upper": "",
            "lower": ""
